...
if (!class_exists('TTO_Blocks')) {
    class TTO_Blocks
    {
        ...
        public function start()
        {
            ...
            self::tto_block_pattern_category();
            ...
            if (function_exists('register_block_style')) {
                 ...
                 * @return void
                 */
                add_action('init', array( $this, 'twenty_twenty_one_register_block_styles'));
            }
        }

        // Register Block Styles
        public function twenty_twenty_one_register_block_styles()
        {
        ...
        // Register Block Patterns & Pattern Category
        public function tto_block_pattern_category()
        {
