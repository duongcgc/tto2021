...
class TTO_Dark_Mode {
    ...
    public function editor_custom_color_variables() {
        ...
        if ($should_respect_color_scheme && TTO_Custom_Colors::get_relative_luminance_from_hex($background_color) > 127) {
    ...
    public function customizer_controls($wp_customize) {
        ...
        include_once get_theme_file_path('classes/class-tto-customize-notice-control.php'); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
        ...
        $wp_customize->add_control(
            new TTO_Customize_Notice_Control(
                $wp_customize,
                'respect_user_color_preference_notice',
                array(
                    'section'         => 'colors',
                    ...
                    'active_callback' => static function () {
                        return 127 >= TTO_Custom_Colors::get_relative_luminance_from_hex(get_theme_mod('background_color', 'D1E4DD'));
                    },
                )
            )
        );
    ...
    public function html_classes($classes) {
        ...
        $background_color            = get_theme_mod('background_color', 'D1E4DD');
        $should_respect_color_scheme = get_theme_mod('respect_user_color_preference', false);
        if ($should_respect_color_scheme && 127 <= TTO_Custom_Colors::get_relative_luminance_from_hex($background_color)) {
    ...
    public function switch_should_render() {
        global $is_IE;
        return (get_theme_mod('respect_user_color_preference', false) &&
            !$is_IE &&
            127 <= TTO_Custom_Colors::get_relative_luminance_from_hex(get_theme_mod('background_color', 'D1E4DD'))
        );
    }
    ...
    public function the_html($attrs = array()) {
        ...
        <style>
            ...
            <?php if (is_admin() || wp_is_json_request()) : ?>.components-editor-notices__pinned~.edit-post-visual-editor #dark-mode-toggler {
                z-index: 20;
            }
